...
struct C2S_Login FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_ID_TOKEN = 6,
    VT_CONNECTED_AT = 8,
    VT_TOKEN_EXPIRES_IN = 10
  };
  uint8_t socket_id() const {
    return GetField<uint8_t>(VT_SOCKET_ID, 0);
  }
  const ::flatbuffers::String *id_token() const {
    return GetPointer<const ::flatbuffers::String *>(VT_ID_TOKEN);
  }
  int64_t connected_at() const {
    return GetField<int64_t>(VT_CONNECTED_AT, 0);
  }
  ...
  bool Verify(::flatbuffers::VerifierTemplate<B> &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint8_t>(verifier, VT_SOCKET_ID, 1) &&
           VerifyOffset(verifier, VT_ID_TOKEN) &&
           verifier.VerifyString(id_token()) &&
           VerifyField<int64_t>(verifier, VT_CONNECTED_AT, 8) &&
...
struct C2S_LoginBuilder {
  ...
  void add_socket_id(uint8_t socket_id) {
    fbb_.AddElement<uint8_t>(C2S_Login::VT_SOCKET_ID, socket_id, 0);
  }
  void add_id_token(::flatbuffers::Offset<::flatbuffers::String> id_token) {
    fbb_.AddOffset(C2S_Login::VT_ID_TOKEN, id_token);
  }
  void add_connected_at(int64_t connected_at) {
    fbb_.AddElement<int64_t>(C2S_Login::VT_CONNECTED_AT, connected_at, 0);
  }
...
inline ::flatbuffers::Offset<C2S_Login> CreateC2S_Login(
  ...
  builder_.add_connected_at(connected_at);
  builder_.add_id_token(id_token);
  builder_.add_socket_id(socket_id);
